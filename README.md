...
**Contents**:
- [Multimodal inference through mental simulation](#multimodal-inference-through-mental-simulation)
...
Final form paper figures as well as stimuli images for both experiments. Screenshots for the prediction experiment
