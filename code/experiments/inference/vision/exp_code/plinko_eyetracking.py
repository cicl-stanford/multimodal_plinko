...
def show_instruct(win):
    ...
    inst2 = ("Now that you have a sense for how the world works, we can run some trials. "
             "In each trial we will show you a still image of the plinko box after we have dropped in the ball. "
             "It's your job to determine which of the three holes the ball came from. You will answer on the keypad using the number keys 1, 2, and 3. "
             "Hole 1 is the farthest to your left, 2 is the middle, and 3 is on your right. Let's get started with calibration and then proceed to the experiment.")
    show_text(win, inst2)
...
def run_experiment():
    ...
    # _ = libscreen.Screen(disptype='psychopy')
    # win = pygaze.expdisplay
    show_instruct(win)
